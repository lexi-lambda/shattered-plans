...
public class AccountFrame extends ContentFrame implements ButtonListener {
  ...
  public AccountFrame(final RootFrame var1, final Font var2, final String var3, final boolean var4, final boolean var5) {
    super(var1, new DialogForm(null, var2, var3), 77, 10, 10);
  ...
  private static void a150nb() {
    ...
    CommonUI.root.pushActive(CommonUI.contentFrame);
    CommonUI.contentFrame.setNextContent(LoginForm.instance);
    CommonUI.contentFrame.skipAnimations();
  }
  ...
  public final void p150() {
    ...
    final DialogForm var2 = new DialogForm(this, this._ub, StringConstants.CONNECTION_RESTORED);
  ...
  public final void handleFailure(@MagicConstant(valuesFromClass = CommonUI.LoginResult.class) final int result, final String reasonMessage) {
    ...
    final DialogForm var4 = new DialogForm(this, this._ub, reasonMessage);
